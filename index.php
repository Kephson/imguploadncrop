...
<head>
    ...
    <script type="text/javascript">
		var useMobile =<?php if ($deviceType == 'tablet' || $deviceType == 'phone') {
            echo 'true';
        } else {
            echo 'false';
        }?>;
...
<div class="wrapper">
    ...
    <div class="uploader">
        ...
        <div id="big_uploader">
            <form name="upload_big" id="upload_big" class="uploaderForm" method="post" enctype="multipart/form-data"
                  action="upload.php?act=upload" target="upload_target">
        ...
        <div class="content">
            ...
            <div id="uploaded">
                ...
                <div class="uploadThumbWrapper">
                    ...
                    <?php } ?>
                    <form name="upload_thumb" id="upload_thumb" class="uploaderForm" method="post"
                          action="upload.php?act=thumb" target="upload_target">
